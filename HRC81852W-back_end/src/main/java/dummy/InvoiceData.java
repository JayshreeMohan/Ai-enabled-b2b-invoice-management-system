...
public class InvoiceData {               
	...
	public InvoiceData(int sl_no, String business_code, int cust_number, Date clear_date, String buisness_year, String doc_id,
			...
			int is_deleted) 
	{
		...
		this.buisness_year = buisness_year.substring(0,4);
		this.doc_id = doc_id;
